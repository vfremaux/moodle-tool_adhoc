...
list($options, $unrecognized) = cli_get_params(
    array('help' => false, 'list' => false, 'execute' => false, 'delete' => false, 'runall' => false, 'showdebug' => false, 'verbose' => false),
    array('h' => 'help')
);
...
--showdebug   Enables the debug mode
--verbose     Tells more
...
if ($options['runall']) {
    ...
    if (!empty($tasks)) {
        ...
        \tool_adhoc\manager::run_tasks($tasks, false, $options['verbose']);
    } else {
